...
class VoucherStockAdd extends StatefulWidget {
  Function refresh;
  VoucherStockAdd({Key? key, required this.refresh}) : super(key: key);

  @override
  State<VoucherStockAdd> createState() => _VoucherStockAddState();
}

List<StockItem> stockVoucherItems = [];

class _VoucherStockAddState extends State<VoucherStockAdd> {
  double top = -500;
  double width = 0;
